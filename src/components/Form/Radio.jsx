...
const Radio = ({
	...
	const [field, meta, helpers] = useField({ ...props, name, type: 'radio' });

	// Updated handleRadioChange to ensure onChange works properly
	function handleRadioChange(event, name, value) {
		onChange(event);  // Pass event to parent if necessary
					...
					<div key={id} className="flex flex-col">
						...
						>
							...
							<input
								...
								// Ensure the event object is passed properly
								onChange={(event) => handleRadioChange(event, name, value)}
							/>
						...
						{props.value === value && onSelectMessage && (
