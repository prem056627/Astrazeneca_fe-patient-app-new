	...
	return (
		<div className="flex flex-col gap-[4px]">
			...
			{isTextarea ? (
				...
				<input
					type={type}
					className="rounded-md border border-[#ACA9A9] px-[16px] py-[14px] font-open-sans text-portal-sm font-semibold text-[#283A46] placeholder:text-[#9A9A9A] hover:outline-0 focus:outline-0 disabled:bg-[#f2f2f2]"
					id={id}
					{...field}
					{...props}
				/>
